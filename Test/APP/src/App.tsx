...
import { Task, ChatMessage, CommunityFeed, DiagnosisRecord, UserProfile, NotificationSettings, CoachStyleType, CategoryType } from "./types.ts";
import { DEFAULT_TASKS, DEFAULT_FEEDS, DEFAULT_DIAGNOSIS, DEFAULT_PROFILE, DEFAULT_NOTIFICATIONS } from "./data.ts";

// Sub-screen component imports
import ScreenLogin from "./components/ScreenLogin.tsx";
import ScreenOnboarding from "./components/ScreenOnboarding.tsx";
import ScreenDashboard from "./components/ScreenDashboard.tsx";
import ScreenTasks from "./components/ScreenTasks.tsx";
import ScreenAnalytics from "./components/ScreenAnalytics.tsx";
import ScreenAICoach from "./components/ScreenAICoach.tsx";
import ScreenCommunity from "./components/ScreenCommunity.tsx";
import ScreenSettings from "./components/ScreenSettings.tsx";
...
export default function App() {
  ...
  useEffect(() => {
    ...
    if (cachedScreen) setCurrentScreen(cachedScreen);
  ...
  const renderCurrentScreen = () => {
    switch (currentScreen) {
      ...
      case "analytics":
        return <ScreenAnalytics diagnosisRecords={diagnosisRecords} />;
      case "ai-coach":
        return (
          <ScreenAICoach
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex items-center justify-center p-0 sm:p-4">
      <div className="relative w-full max-w-[393px] bg-white min-h-screen shadow-2xl overflow-hidden flex flex-col sm:rounded-2xl border sm:border-slate-200">
        ...
        {hasBottomNav && (
          <nav className="fixed bottom-0 sm:absolute left-0 w-full bg-white/90 backdrop-blur-xl border-t border-slate-100 h-20 flex justify-around items-center px-4 py-2 z-50">
            ...
            <button 
              ...
              className={`flex flex-col items-center gap-1 flex-1 py-1.5 transition-colors focus:outline-none ${
                currentScreen === "dashboard" ? "text-[#4e6535]" : "text-slate-405 hover:text-slate-600 text-slate-400"
              }`}
            >
            ...
            <button 
              ...
              className={`flex flex-col items-center gap-1 flex-1 py-1.5 transition-colors focus:outline-none ${
                currentScreen === "tasks" ? "text-[#4e6535]" : "text-slate-405 hover:text-slate-600 text-slate-400"
              }`}
            >
            ...
            <button 
              ...
              className={`flex flex-col items-center gap-1 flex-1 py-1.5 transition-colors focus:outline-none ${
                currentScreen === "analytics" ? "text-[#4e6535]" : "text-slate-405 hover:text-slate-600 text-slate-400"
              }`}
            >
            ...
            <button 
              ...
              className={`flex flex-col items-center gap-1 flex-1 py-1.5 transition-colors focus:outline-none ${
                currentScreen === "ai-coach" ? "text-[#4e6535]" : "text-slate-405 hover:text-slate-600 text-slate-400"
              }`}
            >
            ...
            <button 
              ...
              className={`flex flex-col items-center gap-1 flex-1 py-1.5 transition-colors focus:outline-none ${
                currentScreen === "community" ? "text-[#4e6535]" : "text-slate-405 hover:text-slate-600 text-slate-400"
              }`}
            >
            ...
            <button 
              ...
              className={`flex flex-col items-center gap-1 flex-1 py-1.5 transition-colors focus:outline-none ${
                currentScreen === "settings" ? "text-[#4e6535]" : "text-slate-405 hover:text-slate-600 text-slate-400"
              }`}
            >
